            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-0.5 font-medium">Manage internal bills, approvals, and tax invoices.</p>
                    </div>
                </div>
                <Link href="/dashboard/accounts/billing/create">
                    <Button className="shadow-sm font-medium h-10 px-4">
