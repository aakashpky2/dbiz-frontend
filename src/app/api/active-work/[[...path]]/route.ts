...
export const GET = (req: NextRequest, ctx: any) => proxyRequest(req, ctx, 'active-work');
export const POST = (req: NextRequest, ctx: any) => proxyRequest(req, ctx, 'active-work');
export const PUT = (req: NextRequest, ctx: any) => proxyRequest(req, ctx, 'active-work');
export const PATCH = (req: NextRequest, ctx: any) => proxyRequest(req, ctx, 'active-work');
export const DELETE = (req: NextRequest, ctx: any) => proxyRequest(req, ctx, 'active-work');
export const OPTIONS = (req: NextRequest, ctx: any) => proxyRequest(req, ctx, 'active-work');
