export const countryPhoneCodes = [
  ...
  { code: '+297', name: 'Aruba' },
  { code: '+61', name: 'Australia / Christmas Island / Cocos Islands' },
  ...
  { code: '+599', name: 'Curacao / Netherlands Antilles' },
  { code: '+64', name: 'New Zealand / Pitcairn' },
  { code: '+262', name: 'Mayotte / Reunion' },
  { code: '+7', name: 'Kazakhstan / Russia' },
  { code: '+590', name: 'Saint Barthelemy / Saint Martin' },
  { code: '+47', name: 'Norway / Svalbard and Jan Mayen' },
